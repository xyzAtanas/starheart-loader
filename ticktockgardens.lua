...
local starTeleports = {
    { "Fit for a King",             Vector3.new(124, 334, -2625) },
    { "No Fun in the Dungeon",      Vector3.new(-41, 215, -1012) },
    { "Time Ticking Triumph",       Vector3.new(459, 425, -234)  },
    { "The Land that Time Forgot",  Vector3.new(143, 164, 2094)  },
    { "Around the Garden Wall",     Vector3.new(784, 210, -799)  },
}
