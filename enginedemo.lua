...
local starTeleports = {
    { "Peak of the Beak",                  Vector3.new(565, 285, -1071)   },
    { "Over the Bell, Under the City",     Vector3.new(2148, 684, -2096)  },
    { "Beat the Heat",                     Vector3.new(-237, 278, -2180)  },
    { "The Shattered City",                Vector3.new(503, 824, -3316)   },
    { "Aquatic Sparks",                    Vector3.new(1641, 311, 2202)   },
    { "Storm the Castle",                  Vector3.new(6677, 1041, -3747) },
    { "You're Awesome finish (no star)",   Vector3.new(-8132, 687, -5125) },
}
for _, tp in ipairs(starTeleports) do
...
local quickTeleports = {
    { "Raven Spire",                    Vector3.new(537, -10, -1185)  },
    { "Concatta Ruins",                 Vector3.new(1040, 36, -1758)  },
    { "Canyon Conservatory",            Vector3.new(-51, 26, -1741)   },
    { "Fractured Citadel",              Vector3.new(352, 146, -2481)  },
    { "The Waterworks",                 Vector3.new(1962, 106, 450)   },
    { "Forbidden Kingdom",              Vector3.new(6125, 64, -1673)  },
    { "Mount Awesome",                  Vector3.new(-8188, -3, -3962) },
    { "Hydraulic Press Island",         Vector3.new(637, 80, -1539)   },
    { "Awesome Zone",                   Vector3.new(164, 102, -1520)  },
    { "World's Worst Game of Hockey",   Vector3.new(175, 77, -1967)   },
    { "Blender Island",                 Vector3.new(659, 60, -1971)   },
}
for _, tp in ipairs(quickTeleports) do
    local name, pos = tp[1], tp[2]
    QuickTab:Button({
        Title = "Teleport to " .. name,
        Callback = function()
